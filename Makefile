...
slimpytest: install
	...
	@$(ULIMIT_CMD) pytest $(PYTEST_COMMON_ARGS) tests/test_{catalog,dirs,env,exprs,function,index,snapshot,table,view}.py tests/test_fts_index.py tests/share/test_packager.py
